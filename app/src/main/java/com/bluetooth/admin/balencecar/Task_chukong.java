...
public class Task_chukong extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        break9=findViewById(R.id.button_break9);
        frameLayout= findViewById(R.id.frameLayout_chukong);
        ...
        smallBall.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                b3=b3%10;
                b4=y%10;
                String s=s1+a1+a2+a3+a4+b1+b2+b3+b4+s2;
        ...
        break9.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent =new Intent(Task_chukong.this,Task_8.class);

...
public class Task_8 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        break8=findViewById(R.id.button_break8);
        mbchukong=findViewById(R.id.button_chukong);
        mbjiguang=findViewById(R.id.button_jiguang);

        break8.setOnClickListener(new View.OnClickListener() {
        @Override
        public void onClick(View v) {
            v.performHapticFeedback(HapticFeedbackConstants.LONG_PRESS,HapticFeedbackConstants.FLAG_IGNORE_GLOBAL_SETTING);
            Intent intent =new Intent(Task_8.this,MainInterface.class);
